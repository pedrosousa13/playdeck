...
Measured 2026-09-09 on Node v22.23.2, Vite 8.1.5, esbuild
...
| ---------------------- | -------------- | ---------------------------------------------------------------------------------- | -------------- | ----------------- | ------ | -------------------- |
| Playdeck (no parts)    | 1.1.0          | core + native provider, no control parts                                           | 19.98 KB       | 20.76 KB          | +3.9%  | 7 chunks, 283.14 KB  |
| Playdeck               | 1.1.0          | core + primitives + native provider                                                | 20.66 KB       | 21.45 KB          | +3.8%  | 7 chunks, 283.13 KB  |
| Playdeck (play-only)   | 1.1.0          | core + primitives + native provider + one control (PlayButton)                     | 21.72 KB       | 22.57 KB          | +3.9%  | 7 chunks, 283.15 KB  |
| Playdeck (control bar) | 1.1.0          | core + primitives + native provider + control bar (5 of Media Chrome's 7 controls) | 24.37 KB       | 25.36 KB          | +4.0%  | 7 chunks, 283.15 KB  |
...
| Video.js 10 (beta)     | 10.0.0-beta.32 | VideoPlayer + VideoSkin + Video (`@videojs/react/video` preset)                    | 52.14 KB       | 56.56 KB          | +8.5%  | 0                    |
