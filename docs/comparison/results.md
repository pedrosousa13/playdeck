...
| ---------------------- | -------------- | ---------------------------------------------------------------------------------- | -------------- | ----------------- | ------ | -------------------- |
| Playdeck               | 1.0.0          | core + primitives + native provider                                                | 20.12 KB       | 20.89 KB          | +3.8%  | 7 chunks, 282.17 KB  |
| Playdeck (control bar) | 1.0.0          | core + primitives + native provider + control bar (5 of Media Chrome's 7 controls) | 23.83 KB       | 24.79 KB          | +4.0%  | 7 chunks, 282.20 KB  |
