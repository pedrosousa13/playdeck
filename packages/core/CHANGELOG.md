...
- 2902590: Stop a playback patch without a confirming event from consuming a command's origin
...
- 85e38d1: A command issued before a provider attaches is now published on
