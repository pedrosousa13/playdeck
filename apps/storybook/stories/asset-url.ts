 ...
 * the resolver is here rather than the literal (#435). `README.md`'s "Base
 * path" section carries the build-and-serve pair that shows the 404, and the
 * note that nothing automated runs it any more.
 *
