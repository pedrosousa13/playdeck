...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.1 + primitives 21.2 + native 6.7                            | **37.0 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.5                                        | **42.5 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **211.7 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 42.5 + hls.js light 113.0 | **155.5 KB** |
| YouTube                                           | core 9.1 + primitives 21.2 + adapter 6.2                           | **36.5 KB**  |
| Vimeo                                             | core 9.1 + primitives 21.2 + adapter 8.3 + `@vimeo/player` 8.5     | **47.1 KB**  |
| Wistia                                            | core 9.1 + primitives 21.2 + adapter 5.9                           | **36.2 KB**  |
...
at 9.1 KB, the primitives at 21.2 KB, `theme.css` at 2.4 KB and `docked.css` at
