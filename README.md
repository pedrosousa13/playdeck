...
| Vimeo                                             | core 8.0 + primitives 18.4 + adapter 8.3 + `@vimeo/player` 8.5     | **43.2 KB**  |
| Wistia                                            | core 8.0 + primitives 18.4 + adapter 5.9                           | **32.3 KB**  |
...
at 8.0 KB, the primitives at 18.4 KB, `theme.css` at 2.4 KB and `docked.css` at
