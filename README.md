...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.1 + primitives 21.0 + native 6.7                            | **36.8 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.5                                        | **42.3 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **211.5 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 42.3 + hls.js light 113.0 | **155.3 KB** |
| YouTube                                           | core 9.1 + primitives 21.0 + adapter 6.2                           | **36.3 KB**  |
| Vimeo                                             | core 9.1 + primitives 21.0 + adapter 8.3 + `@vimeo/player` 8.5     | **46.9 KB**  |
| Wistia                                            | core 9.1 + primitives 21.0 + adapter 5.9                           | **36.0 KB**  |
...
at 9.1 KB, the primitives at 21.0 KB, `theme.css` at 2.4 KB and `docked.css` at
