...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.1 + primitives 19.8 + native 6.7                            | **35.6 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.5                                        | **41.1 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **210.3 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 41.1 + hls.js light 113.0 | **154.1 KB** |
| YouTube                                           | core 9.1 + primitives 19.8 + adapter 6.2                           | **35.1 KB**  |
| Vimeo                                             | core 9.1 + primitives 19.8 + adapter 8.3 + `@vimeo/player` 8.5     | **45.7 KB**  |
| Wistia                                            | core 9.1 + primitives 19.8 + adapter 5.9                           | **34.8 KB**  |
...
at 9.1 KB, the primitives at 19.8 KB, `theme.css` at 2.4 KB and `docked.css` at
