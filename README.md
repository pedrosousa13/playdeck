...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 7.8 + primitives 18.2 + native 5.9                            | **31.9 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.0                                        | **36.9 KB**  |
...
in at 7.8 KB, the primitives at 18.2 KB and `theme.css` at 2.3 KB — measured on
