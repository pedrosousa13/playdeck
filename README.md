...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.1 + primitives 20.4 + native 6.7                            | **36.2 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.5                                        | **41.7 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **210.9 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 41.7 + hls.js light 113.0 | **154.7 KB** |
| YouTube                                           | core 9.1 + primitives 20.4 + adapter 6.2                           | **35.7 KB**  |
| Vimeo                                             | core 9.1 + primitives 20.4 + adapter 8.3 + `@vimeo/player` 8.5     | **46.3 KB**  |
| Wistia                                            | core 9.1 + primitives 20.4 + adapter 5.9                           | **35.4 KB**  |
...
at 9.1 KB, the primitives at 20.4 KB, `theme.css` at 2.4 KB and `docked.css` at
