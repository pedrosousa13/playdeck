...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 8.0 + primitives 18.3 + native 6.0                            | **32.3 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.0                                        | **37.3 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **206.5 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 37.3 + hls.js light 113.0 | **150.3 KB** |
| YouTube                                           | core 8.0 + primitives 18.3 + adapter 6.2                           | **32.5 KB**  |
| Vimeo                                             | core 8.0 + primitives 18.3 + adapter 8.2 + `@vimeo/player` 8.5     | **43.0 KB**  |
| Wistia                                            | core 8.0 + primitives 18.3 + adapter 5.8                           | **32.1 KB**  |
...
and Playdeck's HLS adapter over it is 5.0. What lazy loading buys is not a
...
at 8.0 KB, the primitives at 18.3 KB, `theme.css` at 2.3 KB and `docked.css` at
