...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.0 + primitives 19.8 + native 6.7                            | **35.5 KB**  |
| HLS on Safari and iOS                             | the above + HLS adapter 5.5                                        | **41.0 KB**  |
| HLS on Chrome, Edge, Firefox                      | the above + **hls.js 169.2**                                       | **210.2 KB** |
| HLS on Chrome, Edge, Firefox, with `hls.js/light` | core + primitives + native + HLS adapter 41.0 + hls.js light 113.0 | **154.0 KB** |
| YouTube                                           | core 9.0 + primitives 19.8 + adapter 6.2                           | **35.0 KB**  |
| Vimeo                                             | core 9.0 + primitives 19.8 + adapter 8.3 + `@vimeo/player` 8.5     | **45.6 KB**  |
| Wistia                                            | core 9.0 + primitives 19.8 + adapter 5.9                           | **34.7 KB**  |
...
at 9.0 KB, the primitives at 19.8 KB, `theme.css` at 2.4 KB and `docked.css` at
