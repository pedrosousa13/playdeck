...
| ------------------------------------------------- | ------------------------------------------------------------------ | ------------ |
| MP4 or WebM                                       | core 9.1 + primitives 20.0 + native 6.7                            | **35.8 KB**  |
...
| YouTube                                           | core 9.1 + primitives 20.0 + adapter 6.2                           | **35.3 KB**  |
| Vimeo                                             | core 9.1 + primitives 20.0 + adapter 8.3 + `@vimeo/player` 8.5     | **45.9 KB**  |
| Wistia                                            | core 9.1 + primitives 20.0 + adapter 5.9                           | **35.0 KB**  |
...
at 9.1 KB, the primitives at 20.0 KB, `theme.css` at 2.4 KB and `docked.css` at
